...
fun getUncheckoutOrderByCanteenId(
    canteenId: Int,
): Order? {
...
val categoryMenuList = listOf(
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                ...
                addOnCategoryId = listOf(0, 2, 3),
                preparationTime = 15
            ),
            Menu(
                id = 1,
                name = "Tahu Telor Spesial",
                price = 10000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/2b31923cb4aff00c/680x482cq70/tahu-telur-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2, 3),
    ...
    MenuCategory(
        ...
        menus = listOf(
            ...
            Menu(
                id = 3,
                name = "Lalapan Ikan Bakar",
                price = 17000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/c1a5341e7292da77/680x482cq70/bumbu-ikan-bakar-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2, 3),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                ...
                price = 5000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/bf000d5f873791e7/1200x630cq70/photo.jpg",
                addOnCategoryId = listOf(1, 2),
                preparationTime = 15
            ),
            Menu(
                id = 5,
                ...
                price = 6000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/67493461f6a46476/680x482cq70/sambal-matah-bali-foto-resep-utama.jpg",
                addOnCategoryId = listOf(1, 2),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            ...
            Menu(
                ...
                price = 22000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/cad04dda37c642b6/680x482cq70/dori-katsu-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2, 3),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                ...
                price = 13000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/f909207cc86efcda/680x482cq70/chicken-katsu-curry-sauce-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2),
                preparationTime = 15
            ),
            Menu(
                id = 9,
                name = "Nasi Dori Katsu",
                price = 15000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/3915965642b5b141/680x482cq70/nasi-dori-cabe-bawang-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                ...
                price = 18000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/08bd3fb1141d272b/680x482cq70/ayam-ramen-foto-resep-utama.jpg",
                addOnCategoryId = listOf(3, 2),
                preparationTime = 15
            ),
            Menu(
                id = 11,
                ...
                price = 20000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/ddbf907fd1f8a7dc/1200x630cq70/photo.jpg",
                addOnCategoryId = listOf(3, 2),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            ...
            Menu(
                ...
                price = 16000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/5434dafc8b5b3fc5/680x482cq70/ayam-bakar-madu-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2, 3),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                ...
                price = 18000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/2556314567203ac5/680x482cq70/nasi-bakar-ayam-suwir-kemangi-foto-resep-utama.jpg",
                addOnCategoryId = listOf(0, 2),
                preparationTime = 15
            ),
            Menu(
                ...
                price = 19000.0,
                isAvailable = true,
                imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMtcjurQgVRznOH7xWm7Sn6r60TUMjXt_gZw&s",
                addOnCategoryId = listOf(0, 2),
                preparationTime = 15
            )
        )
    ...
    MenuCategory(
        ...
        menus = listOf(
            Menu(
                id = 16,
                name = "Sambal Bakar Terasi",
                price = 6000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/60463007fb1a3a69/680x482cq70/sambal-bakar-terasi-foto-resep-utama.jpg",
                addOnCategoryId = listOf(1, 2),
                preparationTime = 15
            ),
            Menu(
                id = 17,
                name = "Sambal Bakar Matah",
                price = 7000.0,
                isAvailable = true,
                imageUrl = "https://img-global.cpcdn.com/recipes/c9c57db41113c5d2/680x482cq70/tempe-bakar-sambal-matah-foto-resep-utama.jpg",
                addOnCategoryId = listOf(1, 2),
                preparationTime = 15
            )
        )
...
val orderList = listOf(
    Order(
        ...
        finishedTime = "",
        scheduleTime = "2025-05-09T12:00:00",
        estimationTime = 15,
        totalPrice = 10000.0,
        orderItem = listOf(
            OrderItem(
                ...
                details = "Tanpa sambal, tambahkan kecap.",
                addOns = listOf(
                    AddOn(id = 1, name = "Sambal Matah", price = 2000.0),
                )
            ),
